...
function appendMayaiStructureReferenceClarity(userMessage: string): string {
  ...
  return [
    ...
    "- Ссылка на статью mayai.ru — только **структура, стиль, ритм, блоки и ориентир длины**; **не** источник фактов и **не** источник картинок для тела статьи; текст не копировать.",
